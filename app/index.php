...
<head>
    ...
    <meta name="description" content="Jean-Louis Parent Développeur Web Annecy">
    <meta name="keywords" content="Jl Parent Jean-Louis J-L developpeur web developer annecy france geneve">
    <meta name="author" content="Jean-Louis Parent">
    <!-- /META -->
    <title>Jean-Louis Parent - Développeur Web</title>
    <!-- STYLES -->
    ...
    <div id="menu">
        ...
        <div id="menu-footer">
            ...
            <div class="menu-footer-text">
              v4.1  &copy; Jean-Louis Parent 2015
          </div>
        ...
        <div class="accueil-top-bar">
            <div class="row">
                ...
                <div class="accueil-contact pull-right col-md-5 text-right">
                    <a href="#" class="active">Français</a> / <a href="en/">English </a>
            ...
            <div class="row">
                <div class="col-md-<?php  echo (IS_DESKTOP) ? '8' : '12' ?>">
                    ...
                    <div class="col-md-10">
                        ...
                        <p>Je suis <b>Jean-Louis Parent</b>, développeur web à <b>Annecy</b> en Haute-Savoie, France.</p>
                        <p>
                            J'ai 
                            <?php 
                        ...
                        <p>
                            J’ai très vite découvert la programmation et, plus particulièrement, celle des sites internet. Dès lors, j’ai mis toutes mes compétences dans la création de sites internet pour mon plaisir ou pour une cause particulière. 
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="resume-list">
                                <li>
                                    <h5 class="resume-list-title">Licence Pro - Développeur Informatique Multisupports</h5>
                                    <div class="resume-list-describe">
                                        <span><b>2013-2014</b> CCI Formation Multimédia / IUT Annecy</span><br>
                                        <i>Mention Bien</i>
                                    </div>
                                </li>
                                <li>
                                    <h5 class="resume-list-title">DUT Informatique</h5>
                                    <div class="resume-list-describe">
                                ...
                                <li>
                                    <h5 class="resume-list-title">Baccalauréat Scientifique SVT - Physique</h5>
                                    <div class="resume-list-describe">
                                        <span><b>2007-2010</b> Lycée Gabriel Fauré - Annecy</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            ...
                            <ul class="resume-list">
                                <li>
                                    <h5 class="resume-list-title">Développeur / Intégrateur Web Responsive</h5>
                                    <div class="resume-list-describe">
                                        <span><b>2013/2014</b> - Miliboo.com - Pringy</span>
                                        <br>
                                        <i>Apprenti</i>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="resume-list-describe">
                                        <span><b>2013</b> - Web4Agency - Genève - Suisse</span>
                                        <br>
                                        <i>Stagiaire</i>
                                    </div>
                                </li>
        ...
        <div class="content-data-text">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="box-skills rwd">
                        ...
                        <p>
                            Lors de ma licence professionnelle, je me suis spécialisé dans le développement <abbr title="Responsive Web Design">RWD</abbr>.
                        </p>
                        <p>
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="skill-item">
                            <h5>Permis B  <small><i>Véhicule personnel</i></small> </h5>
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                ...
                <div id="cobras" class="work-box">
                    <div class="work-box-text">
                        ...
                        <div class="work-box-desc">
                            <p>Site officiel de Los Cobras, groupe de rock. Actualités, concerts, musique, suivez le groupe dans sa mue.</br>
                                N'hésitez pas à aller écouter leur musique et les soutenir !
                            </p>
            ...
            <div class="col-md-3">
                <div id="miliboo" class="work-box">
                    <div class="work-box-text">
                        ...
                        <div class="work-box-desc">
                            <p>
                                A la recherche de meubles design et de mobilier pour votre intérieur ? Découvrez nos sélections pour tous les styles et tous les goûts avec Miliboo.com.
                            </p>
    ...
    <div class="content-data-text">
        ...
        <div class="contact-text">
            ...
            <ul class="list-contact list-unstyled ">
                <li><i class="fa fa-phone fa-2x"></i> +33 (0) 6.50.71.22.12</li>
                <li><i class="fa fa-comment fa-2x"></i> jeanlouis.parent@gmail.com</li>
                <li class="li-adress"><i class="fa fa-map-marker fa-2x"></i> MEYTHET 74960</li>
                <li class="li-adress"><i class="fa "></i> FRANCE</li>
            </ul>
            <h2 class="">Réseaux sociaux</h2>
            <ul class="list-social list-inline">
                <li class="face"><a href="https://www.facebook.com/jl.parent4" target="_blank"><i class="fa fa-2x fa-facebook"></i></a>
                </li>
                <li class="twit"><a href="https://twitter.com/JLouis_Parent" target="_blank"><i class="fa fa-2x fa-twitter"></i></a>
                </li>
                <li class="linked"><a href="http://fr.linkedin.com/pub/jean-louis-parent/46/597/b/" target="_blank"><i class="fa fa-2x fa-linkedin"></i></a>
                </li>
                <li class="github"><a href="https://github.com/JLouisParent" target="_blank"><i class="fa fa-2x fa-github"></i></a>
                </li>
                <li class="skype"><a href="skype:jlparent4?chat"><i class="fa fa-2x fa-skype"></i></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="content-data-text">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row box-propos">
                    ...
                    <div class="col-md-9">
                        ...
                        <p>
                            Au moment de mon orientation scolaire, le choix s’est tout naturellement porté sur mon domaine de prédilection et je suis conscient de la chance que j'ai eue d’avoir pu faire de ma passion mon métier.
                        </p>
                        <p>
                ...
                <div class="row box-propos">
                    ...
                    <div class="col-md-9">
                        <p>Quand je ne suis pas sur mon ordinateur, je suis un grand amateur de musique et musicien amateur. Je joue de la batterie dans un groupe de rock. <br>
                            Rares sont les moments où je n'ai pas de musique dans les oreilles.
                        </p>
                        <div class="box-music">
                            <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a href="https://github.com/JLouisParent/Siteperso" target="_blank">
